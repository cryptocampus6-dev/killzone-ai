...
if st.button("START ANALYSIS 🚀"):
    ...
    if not df.empty:
        # Get Analysis from GOD MODE Function
        ...
        with c2:
            ...
            fig.update_layout(template="plotly_dark", height=600, title=f"{display_sym} INSTITUTIONAL CHART", xaxis_rangeslider_visible=False)
    ...
    st.info("Select Coin -> Click START ANALYSIS")import streamlit as st
import ccxt
import pandas as pd
import pandas_ta as ta
import plotly.graph_objects as go
